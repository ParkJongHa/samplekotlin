package sample02spring.demo005_quartz
...
//    private val log: Logger = LoggerFactory.getLogger(Demo005Quartz::class.java)
    ...
    fun start()  {
        ...
        try {
            ...
            val jobDetail = JobBuilder.newJob().ofType(sample02spring.demo005_quartz.Demo005QuartzJob::class.java)
                .setJobData(jobDataMap)
                .withIdentity(sample02spring.demo005_quartz.Demo005QuartzJob::class.simpleName+"Identity")
                .build()
